...
public class DiscoveryAdapter  extends RecyclerView.Adapter<DiscoveryAdapter.PerGenryViewHolder> {

    private Activity context;
    private ArrayList<GenryMovieModel> genryMovieModels;


    public DiscoveryAdapter(Activity context, ArrayList<GenryMovieModel> genryMovieModels) {
    ...
    @NonNull
    @Override
    public PerGenryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(context).inflate(R.layout.pergenry_view_list,parent,false);
        return new PerGenryViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull PerGenryViewHolder holder, int position) {
    ...
    public class PerGenryViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            Snackbar snackbar=Snackbar.make(itemView.getRootView(),"item had been clicked successfully",1000);
            snackbar.show();
